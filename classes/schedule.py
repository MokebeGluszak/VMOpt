...
from zzz_tools import check_cannon_columns,  getTimebandId, get_substring_between_parentheses, export_df
...
class Schedule(iDataFrameable):
    source_path: str
    df: pd.DataFrame
    schedule_breaks: Dict[int,ScheduleBreak]
...
def get_schedule_breaks(df: pd.DataFrame) -> Dict[int, ScheduleBreak]:
    breaks:dict[int, ScheduleBreak] = {}
    for index, row in df.iterrows():
        ...
        breaks[block_id] = schedule_break
